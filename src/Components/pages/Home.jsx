  ...
  return (
    <>
      ...
      <div className='page-body'>
        ...
        <span>If all beings are meant for something, why try to improve, compete, achieve, or thrive? Navigating to your end goals in the future means converging with your destiny in the present.  If we are all predestined then you can realize your goals in the present to restructure your reality and affect lasting change today.  If we aren’t predestined, envisioning and acting upon your goals is still the best pathway to success tomorrow!</span>
      </div>
    </>
  );
}
